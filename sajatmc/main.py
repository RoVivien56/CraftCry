...
app = Ursina()
grass_texture  = load_texture('assets/Grass_Block_Textura1.png')
...
Gravel_Texture = load_texture('assets/Gravel_Texture.png')
    ...
    def input(self,key):
        if self.hovered:
            if key == 'left mouse down':
                ...
                if block_pick == 5: voxel = Voxel(position = self.position + mouse.normal, texture = Gravel_Texture)
